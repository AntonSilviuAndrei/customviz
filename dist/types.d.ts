...
export type VisOptions = Record<string, VisOption>;
export type VisOptionValue = Record<string, string>;
...
export type PivotCell = Record<string, Cell>;
export type Row = Record<string, PivotCell | Cell>;
export type VisData = Row[];
export type VisConfig = Record<string, VisConfigValue>;
